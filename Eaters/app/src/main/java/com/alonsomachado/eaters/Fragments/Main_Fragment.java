...
import com.alonsomachado.eaters.Adapters.Promotions_Adapter;
import com.alonsomachado.eaters.Adapters.Restaurant_Adapter;
import com.alonsomachado.eaters.Model.Promocao;
    ...
    public ArrayList<Restaurant> getAssetJsonData(Context context, String arqData) {
        ...
        try {
            ...
            for ( int i=0 ; i< jsonArray.length(); i++ ){
                ...
                /*JSONArray foodlistarray = restaurant.getJSONArray("food_list");
                if(foodlistarray != null) {
                    for (int j = 0; i < foodlistarray.length(); j++) {

                        if(foodlistarray.getJSONObject(j) != null) {
                            JSONObject fooditem = foodlistarray.getJSONObject(j);
                            String food_list = fooditem.getString("name1");

                            Log.e("Food_list ", food_list);
                        }
                    }
                }*/
